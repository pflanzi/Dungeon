...
public class DamageMeleeSkill implements ISkillFunction {
    ...
    public void execute(Entity entity) {
        ...
        switch (((Hero) entity).getLastInputDirection()) {
            ...
            default -> throw new IllegalStateException("Unexpected value: " + ((Hero) entity).getLastInputDirection());
        }

        Point targetPoint =
            SkillTools.calculateLastPositionInRange(
                epc.getPosition(), target, projectileRange);
        Point velocity =
        ...
        new HitboxComponent(
            hit, new Point(0.25f, 0.25f), projectileHitboxSize, collide, null);
    }
}
