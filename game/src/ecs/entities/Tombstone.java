...
public class Tombstone extends Entity {
    ...
    public Tombstone(Ghost ghost) {
        ...
        new HitboxComponent(
                ...
                (you, other, direction) ->
                        System.out.printf(
                                "tombstoneCollisionEnter:\t%s\n", other.getClass().getSimpleName()),
                (you, other, direction) ->
                        System.out.printf(
                                "tombstoneCollisionExit:\t%s\n", other.getClass().getSimpleName()));
    ...
    public void reward() {
        Game.getHero()
                ...
                .ifPresent(
                        hc -> {
                            System.out.printf(
                                    "The hero has been rewarded with %d additional HP!\n",
                                    healAmount);
                            System.out.printf(
                                    "Previous Max HP:\t%d\n",
    ...
    public void punish() {
        Game.getHero()
                ...
                .ifPresent(
                        hc -> {
                            System.out.printf(
                                    "The hero has been punished with %d damage to their current health!\n",
                                    dmgAmount);
                            System.out.printf(
                                    "Previous Current HP:\t%d\n",
